...
import 'package:rice/src/explore_plans/explore_plans_screen.dart';
...
class ExplorePlansPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bloc = ExplorePlansBloc(riceRepository: context.read<RiceRepository>());
    ...
    return Scaffold(
      appBar: ScreenBar(
        Text(
          arguments.title.toUpperCase(), style: Theme.of(context).textTheme.headline2,
        ),
        isBackIcon: false,
      ),
