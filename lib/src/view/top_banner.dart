...
class TopBanner extends StatefulWidget {
  ...
  TopBanner(
      {this.children = const <CarouselBanner>[],
      this.height = 300,
      this.onTap,
...
class _TopBannerState extends State<TopBanner> {
  ...
  Widget build(BuildContext context) {
    return Stack(children: [
      widget.children != null && widget.children.length > 0
          ? _carouselSlider()
          : SizedBox(),
      Positioned(bottom: 0.0, left: 0.0, right: 0.0, child: _dots())
    ]);
  }
  ...
  Widget _carouselSlider() {
    ...
    double viewportFraction =
        (fullWidth - widget.horizontalPadding! * 2) / fullWidth;
      ...
      children: mapIndexed(widget.children, (index, dynamic vaue) {
        return Container(
          ...
          decoration: BoxDecoration(
              ...
              color: _current == index ? Color(0xFF3345A9) : Color(0XFFD8D8D8)),
        );
      }).toList(),
    );
  }
