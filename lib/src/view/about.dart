...
/// affordance to call [showAboutDialog] or (at least) [showAppLicensePage].
...
/// provide an affordance to call [showAppLicensePage].
///
...
///
/// To show a [LicensePage], use [showAppLicensePage].
///
/// The [AboutDialog] shown by [showAboutDialog] and [AboutListTile] includes
/// a button that calls [showAppLicensePage].
///
/// The licenses shown on the [LicensePage] are those returned by the
/// [LicenseRegistry] API, which can be used to add more licenses to the list.
...
class _LicensePageState extends State<LicensePage> {
  ...
  Widget build(BuildContext context) {
    return _MasterDetailFlow(
      ...
      title: Text(widget.title, style: Theme.of(context).appBarTheme.textTheme!.headline2),
